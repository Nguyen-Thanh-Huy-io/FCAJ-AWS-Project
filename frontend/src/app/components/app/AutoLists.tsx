          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div
                  ...
                  style={{ backgroundColor: useAITimes ? "#0A0A0A" : "#E5E7EB", justifyContent: useAITimes ? "flex-end" : "flex-start", padding: "0 2px" }}
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <div
                  className="w-9 h-5 rounded-full cursor-pointer flex items-center transition-colors"
                  style={{ backgroundColor: activeRecycle ? "#0A0A0A" : "#E5E7EB", justifyContent: activeRecycle ? "flex-end" : "flex-start", padding: "0 2px" }}
