...
export const ALL_PLATFORMS = [
  { id: "YouTube", name: "YouTube", icon: "YT", color: PLATFORM_COLORS.YouTube },
...
export const WORKPLACE_INDUSTRIES = ["Technology", "Real Estate", "Fashion", "Entertainment", "Food & Beverage", "Education"];
