    ...
    <div className="p-6" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          ...
          <div className="col-span-2">
            <ResponsiveContainer width="100%" height={200}>
              <AreaChart data={mrrData}>
                ...
                <Area type="monotone" dataKey="mrr" stroke="#0A0A0A" fill="#F3F4F6" strokeWidth={1.5} name="MRR" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
      ...
      <div className="bg-white rounded-xl overflow-hidden mb-6" style={{ border: "0.5px solid #E5E7EB" }}>
        ...
        <table className="w-full">
          ...
          <tbody>
            {[
              { plan: "Free", color: "#D1D5DB", subs: "561", mrr: "$0", arpu: "$0", churn: "—", newSubs: "89", cancelled: "—", conv: "12%", highlight: false },
              { plan: "Starter", color: "#6B7280", subs: "349", mrr: "$6,631", arpu: "$19", churn: "2.8%", newSubs: "42", cancelled: "11", conv: "28%", highlight: false },
              { plan: "Pro", color: "#0A0A0A", subs: "274", mrr: "$13,426", arpu: "$49", churn: "1.9%", newSubs: "31", cancelled: "6", conv: "35%", highlight: true },
              { plan: "Agency", color: "#444", subs: "63", mrr: "$28,234", arpu: "$448", churn: "0.8%", newSubs: "7", cancelled: "1", conv: "44%", highlight: false },
            ].map((row) => (
              <tr key={row.plan} style={{ borderBottom: "0.5px solid #F3F4F6", backgroundColor: row.highlight ? "#F8F8F7" : "transparent" }}>
                    ...
                    <td key={i} className="px-1 py-1">
                      <div
                        ...
                        style={{ 
                          ...
                          color: val !== null && val >= 70 ? "#fff" : "#9CA3AF" 
                        }}
                      >
