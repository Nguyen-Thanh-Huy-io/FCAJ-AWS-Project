          ...
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={communityGrowthData}>
               ...
               {selectedMetrics.subscribers && (
                 <Area type="monotone" dataKey="subscribers" stroke="#8E9BEE" fillOpacity={0.1} fill="url(#colorSubscribers)" strokeWidth={3} dot={{ fill: '#8E9BEE', strokeWidth: 2, r: 4, stroke: '#fff' }} activeDot={{ r: 6 }} connectNulls={true} />
               )}
               {selectedMetrics.views && (
                 <Line type="monotone" dataKey="views" stroke="#86EFAC" strokeWidth={2} dot={{ fill: '#86EFAC', r: 4, stroke: '#fff', strokeWidth: 2 }} activeDot={{ r: 6 }} connectNulls={true} />
               )}
               {selectedMetrics.revenue && (
                 <Line type="monotone" dataKey="revenue" stroke="#C084FC" strokeWidth={2} dot={{ fill: '#C084FC', r: 4, stroke: '#fff', strokeWidth: 2 }} activeDot={{ r: 6 }} connectNulls={true} />
               )}
