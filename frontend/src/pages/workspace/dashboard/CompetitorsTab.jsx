              ...
              {isCompetitorLoading ? (
                ...
                <tbody className="divide-y divide-gray-50">
                  {competitors.length === 0 ? (
                    <tr><td colSpan="6" className="px-6 py-10 text-center text-gray-400 text-xs">No competitors added yet.</td></tr>
                          ...
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <button className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors cursor-pointer border-none bg-transparent focus:outline-none">
                                <MoreVertical size={16} className="text-gray-400 hover:text-[#0A0A0A]" />
                              </button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent align="end" className="w-48 bg-white border border-gray-100 rounded-2xl shadow-xl py-2 z-50 text-left">
                              <DropdownMenuItem 
                                onClick={() => setSelectedCompetitorForStats(comp)}
                                className="px-4 py-2 flex items-center gap-2.5 text-xs text-gray-700 hover:bg-gray-50 font-medium cursor-pointer border-none outline-none focus:outline-none"
                              >
                                <BarChart2 size={14} className="text-gray-400" /> More stats
                              </DropdownMenuItem>
                              <DropdownMenuItem 
                                onClick={() => {
                                ...
                                className="px-4 py-2 flex items-center gap-2.5 text-xs text-gray-700 hover:bg-gray-50 font-medium cursor-pointer border-none outline-none focus:outline-none"
                              >
                                <ExternalLink size={14} className="text-gray-400" /> Watch the original
                              </DropdownMenuItem>
