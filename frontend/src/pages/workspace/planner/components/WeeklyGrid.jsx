...
const renderPlatformIcon = (platformName) => {
  ...
  if (p === 'FACEBOOK') {
    return (
      <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current text-gray-500 shrink-0">
  ...
  if (p === 'INSTAGRAM') {
    return (
      <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 stroke-current text-gray-500 fill-none shrink-0" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <p className="text-[11px] font-medium text-gray-700 line-clamp-3 leading-normal">
                          ...
                          {hasMedia && (
                            <div className="mt-1 flex items-center">
                              <div className="w-8 h-8 rounded-md bg-gray-50 overflow-hidden flex items-center justify-center shrink-0 border border-gray-100">
                                {thumbUrl ? (
