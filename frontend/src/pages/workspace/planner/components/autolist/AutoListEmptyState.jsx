  ...
  return (
    <div className="bg-white/80 backdrop-blur-md border border-gray-100 rounded-3xl p-12 text-center shadow-sm flex flex-col items-center justify-center space-y-4 max-w-xl mx-auto my-12 animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="space-y-1">
        <h3 className="text-base font-bold text-gray-900">No autolists created yet</h3>
        <p className="text-xs text-gray-400 max-w-xs mx-auto">Create your first queue to automate your content strategy across multiple networks.</p>
      </div>
      <button 
      ...
      >
        <Plus size={16} /> Create your first autolist
      </button>
    </div>
  );
}
