  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="flex gap-2 p-4 bg-white" style={{ borderBottom: "0.5px solid #E5E7EB" }}>
        ...
        {["landing", "accepted", "expired", "already-member"].map((s) => (
          <button
            key={s}
            onClick={() => setScreen(s)}
            ...
            style={{ 
              fontSize: 11, 
              backgroundColor: screen === s ? "#0A0A0A" : "#F3F4F6", 
        ...
        <div className="flex h-[calc(100vh-48px)]">
          ...
          <div className="w-2/5 bg-[#0A0A0A] flex flex-col p-8">
            ...
            <div className="flex flex-col items-center text-center py-12">
              ...
              <p style={{ fontSize: 15, color: "#fff", marginBottom: 4 }}>John Doe invited you</p>
              ...
              <div className="px-4 py-2 rounded-full mb-4" style={{ backgroundColor: "#1E1E1E", border: "0.5px solid #333" }}>
                <span style={{ fontSize: 14, color: "#DDD" }}>Invitation Link</span>
              </div>
      ...
      {screen === "accepted" && (
        <div className="flex items-center justify-center h-[calc(100vh-48px)]">
          <div className="bg-white rounded-2xl p-10 text-center" style={{ maxWidth: 480, border: "0.5px solid #E5E7EB" }}>
            ...
            <p style={{ fontSize: 14, color: "#6B7280", marginBottom: 16 }}>You've joined the team successfully.</p>
      ...
      {screen === "already-member" && (
        <div className="flex items-center justify-center h-[calc(100vh-48px)]">
          <div className="bg-white rounded-2xl p-10 text-center" style={{ maxWidth: 480, border: "0.5px solid #E5E7EB" }}>
            ...
            <p style={{ fontSize: 13, color: "#6B7280", lineHeight: 1.6, marginBottom: 24 }}>
              You already have access to TechVision workspace.
            </p>
