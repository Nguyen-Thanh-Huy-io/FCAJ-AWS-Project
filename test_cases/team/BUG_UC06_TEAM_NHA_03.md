...
Steps to reproduce
1. Đăng nhập vào hệ thống và đi tới mục Quản lý đội ngũ (Team) tại URL `/manage/team`. Nhấp nút "Invite Member" để mở modal mời thành viên mới.
2. Nhập một email đã là thành viên trong đội ngũ nhưng có khoảng trắng thừa ở đầu hoặc cuối (ví dụ: ` test@gmail.com `) vào ô mời thành viên.
3. Chọn một vai trò tùy chỉnh khác và bấm gửi lời mời.
