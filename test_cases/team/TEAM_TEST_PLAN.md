...
*   **TC_TEAM_01: Đăng ký Owner mới và hoàn tất onboarding**
    ...
    *   **Kịch bản chi tiết**: [UC01_UC02_UC05_TEAM_NHA_01.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC01_UC02_UC05_TEAM_NHA_01.md)
...
*   **TC_TEAM_02: Kiểm tra Validation khi mời thành viên (Email rỗng & Sai format)**
    ...
    *   **Kịch bản chi tiết**: [UC06_TEAM_NHA_02.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC06_TEAM_NHA_02.md)
...
*   **TC_TEAM_03: Chặn mời trùng email hiện có (kể cả có khoảng trắng / chữ hoa)**
    ...
    *   **Kịch bản chi tiết**: [UC06_TEAM_NHA_03.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC06_TEAM_NHA_03.md)
...
*   **TC_TEAM_04: Kiểm tra giới hạn thành viên (Plan Seats Limit)**
    ...
    *   **Kịch bản chi tiết**: [UC06_TEAM_NHA_04.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC06_TEAM_NHA_04.md)
...
*   **TC_TEAM_05: Quản lý Custom Role (Tạo mới & validate tên vai trò)**
    ...
    *   **Kịch bản chi tiết**: [UC06_TEAM_NHA_05.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC06_TEAM_NHA_05.md)
...
*   **TC_TEAM_06: Mời thành viên mới với Custom Role**
    ...
    *   **Kịch bản chi tiết**: [UC05_UC06_TEAM_NHA_06.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC05_UC06_TEAM_NHA_06.md)
...
*   **TC_TEAM_07: Quy trình chấp nhận lời mời và Kích hoạt tài khoản thành viên**
    ...
    *   **Kịch bản chi tiết**: [UC07_TEAM_NHA_07.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC07_TEAM_NHA_07.md)
...
*   **TC_TEAM_08: Kiểm chứng phân quyền Custom Role hạn chế trên UI & Backend API**
    ...
    *   **Kịch bản chi tiết**: [UC07_TEAM_NHA_08.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC07_TEAM_NHA_08.md)
...
*   **TC_TEAM_08_C: Kiểm chứng phân quyền xem Báo cáo & Biểu đồ thống kê (VIEW_ANALYTICS)**
    ...
    *   **Kịch bản chi tiết**: [UC07_TEAM_NHA_08_C.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC07_TEAM_NHA_08_C.md)
...
*   **TC_TEAM_08_D: Kiểm chứng Custom Role chỉ có quyền Quản lý thành viên (MANAGE_TEAM)**
    ...
    *   **Kịch bản chi tiết**: [UC07_TEAM_NHA_08_D.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC07_TEAM_NHA_08_D.md)
...
*   **TC_TEAM_08_E: Kiểm chứng Custom Role chỉ có quyền Xem báo cáo (VIEW_ANALYTICS)**
    ...
    *   **Kịch bản chi tiết**: [UC07_TEAM_NHA_08_E.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC07_TEAM_NHA_08_E.md)
...
*   **TC_TEAM_08_F: Kiểm chứng Custom Role chỉ có quyền Quản lý vai trò (MANAGE_ROLES)**
    ...
    *   **Kịch bản chi tiết**: [UC07_TEAM_NHA_08_F.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC07_TEAM_NHA_08_F.md)
...
*   **TC_TEAM_08_G: Kiểm chứng Custom Role chỉ có quyền Phê duyệt bài viết (APPROVE_POSTS) và Xóa bài viết (DELETE_POSTS)**
    ...
    *   **Kịch bản chi tiết**: [UC07_TEAM_NHA_08_G.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC07_TEAM_NHA_08_G.md)
...
*   **TC_TEAM_08_H: Kiểm chứng Custom Role chỉ có quyền Tạo bài viết (CREATE_POSTS) và Đăng bài viết (PUBLISH_POSTS)**
    ...
    *   **Kịch bản chi tiết**: [UC07_TEAM_NHA_08_H.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC07_TEAM_NHA_08_H.md)
...
*   **TC_TEAM_09: Chặn xóa vai trò đang hoạt động & Dọn dẹp dứt điểm**
    ...
    *   **Kịch bản chi tiết**: [UC06_UC20_TEAM_NHA_09.md](file:///d:/Fullit/projects/PubliCast/test_cases/team/UC06_UC20_TEAM_NHA_09.md)
