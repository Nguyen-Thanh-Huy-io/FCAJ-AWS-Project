...
*   **[TC_FB_DB_00](file:///d:/Fullit/projects/PubliCast/test_cases/dashboard/TC_FB_DB_00.md) – Đăng ký người dùng test mới và hoàn tất onboarding**
...
*   **[TC_FB_DB_11](file:///d:/Fullit/projects/PubliCast/test_cases/dashboard/TC_FB_DB_11.md) – Kiểm tra trạng thái Facebook chưa liên kết (Empty State)**
...
*   **[TC_FB_DB_01_03](file:///d:/Fullit/projects/PubliCast/test_cases/dashboard/TC_FB_DB_01_03.md) – Seed DB, kiểm tra Overview Tab, Charts và Date Filter**
...
*   **[TC_FB_DB_04_06](file:///d:/Fullit/projects/PubliCast/test_cases/dashboard/TC_FB_DB_04_06.md) – Kiểm tra tab POSTS (Metrics, Charts, List & Pagination)**
    *   **Mô tả**: Chuyển sang tab "POSTS" để xem thống kê hiệu quả của các bài viết và kiểm tra biểu đồ phân tích.
*   **[TC_FB_DB_07_08](file:///d:/Fullit/projects/PubliCast/test_cases/dashboard/TC_FB_DB_07_08.md) – Kiểm tra tab STORIES (Metrics, List & Pagination)**
    *   **Mô tả**: Chuyển sang tab "STORIES" để xem số liệu phân tích về các tin ngắn tải lên.

### 5. Quản lý Đối thủ cạnh tranh (Competitors)
*   **[TC_FB_DB_09_10](file:///d:/Fullit/projects/PubliCast/test_cases/dashboard/TC_FB_DB_09_10.md) – Kiểm tra tìm kiếm, thêm và xóa đối thủ cạnh tranh**
...
*   **[TC_FB_DB_12_13](file:///d:/Fullit/projects/PubliCast/test_cases/dashboard/TC_FB_DB_12_13.md) – Tải CSV xuất báo cáo (Competitors)**
