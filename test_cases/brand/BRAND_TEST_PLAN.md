...
*   **[TC_BRAND_01](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_01.md) – Hiển thị trang Brand Settings**
...
*   **[TC_BRAND_02](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_02.md) – Brands selector hiển thị**
...
*   **[TC_BRAND_03](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_03.md) – Create brand successfully**
...
*   **[TC_BRAND_04](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_04.md) – Validation: empty name**
    *   **Mã test Selenium**: `TC04 – Validation: empty name` trong `brand.create.spec.js`
    *   **Mô tả**: Xác minh lỗi khi bỏ trống tên thương hiệu.
*   **[TC_BRAND_07](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_07.md) – Admin can see Add brand button**
...
*   **[TC_BRAND_08](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_08.md) – Update brand name**
    *   **Mã test Selenium**: `TC08 – Update brand name` trong `brand.update.spec.js`
    *   **Mô tả**: Thay đổi tên thương hiệu hiện có.
*   **[TC_BRAND_09](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_09.md) – Save button disabled when name unchanged**
    ...
    *   **Bug liên kết**: [BUG_UC05_BRAND_NHA_PC_51_BRAND_UPDATE_DISABLED_COMPARE.md](file:///d:/Fullit/projects/PubliCast/test_cases/brand/BUG_UC05_BRAND_NHA_PC_51_BRAND_UPDATE_DISABLED_COMPARE.md) (Jira Key: `PC-51`)

### 4. Xử lý lỗi & Ràng buộc (Brand Errors & Modal)
*   **[TC_BRAND_14](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_14.md) – Submit disabled when brand name is empty**
...
*   **[TC_BRAND_15](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_15.md) – Cancel brand creation modal works**
...
*   **[TC_BRAND_11](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_11.md) – Delete button disabled when only 1 brand**
...
*   **[TC_BRAND_13](file:///d:/Fullit/projects/PubliCast/test_cases/brand/UC05_BRAND_NHA_13.md) – Delete button visible for admin**
