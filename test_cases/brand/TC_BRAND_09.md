...
## 5. Linked Bug
- Có liên kết với bug report [BUG_PC_51_BRAND_UPDATE_DISABLED_COMPARE.md](file:///d:/Fullit/projects/PubliCast/test_cases/brand/BUG_PC_51_BRAND_UPDATE_DISABLED_COMPARE.md) trên Jira (`PC-51`).
